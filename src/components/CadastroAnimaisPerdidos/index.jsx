...
const CadastroAnimalPerdido = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Salvar
            if (storageDisponivel()) {
                await window.storage.set('animais_perdidos', JSON.stringify(animaisExistentes), true);
            } else {
                localStorage.setItem('animais_perdidos', JSON.stringify(animaisExistentes));
            }
            ...
            <div className="central">
                ...
                <div className="container_cadastro_animal">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            <label htmlFor="data-desaparecimento" className="form-label">Data de Desaparecimento </label>
                            <input 
                                type="date" 
                                className="form-control" 
                        ...
                        <div className="form-group">
                            ...
                            <small className="form-text">Informe onde o animal foi visto pela última vez</small>
                        </div>
