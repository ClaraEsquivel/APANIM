...
const FormasPagamento = () => {
    ...
    useEffect(() => {
        // Recupera dados do plano da navegação
        if (location.state?.plano) {
            setPlanoSelecionado(location.state.plano);
        } else {
            // Se não houver plano selecionado, redireciona para página de planos
        ...
        <>
            ...
            <section className="hero-payment">
                <div className="hero-content">
                    ...
                    <p>Escolha a forma de pagamento e complete sua assinatura</p>
                </div>
            </section>
                    ...
                    <div className="payment-forms">
                        {etapaAtual === 2 && (
                            <button
                                ...
                                aria-label="Voltar para seleção de método"
                                onClick={() => { setEtapaAtual(1); setMetodoPagamento(''); }}
                            >
                                ← Voltar
                            </button>
                        )}
                            ...
                            <div className="payment-card">
                                ...
                                <form className="payment-form">
                                    ...
                                    <button 
                                        ...
                                        disabled={processando}
                                    >
                                        {processando ? 'Gerando PIX...' : 'Gerar QR Code PIX'}
                                    </button>
                                </form>
                            </div>
                        )}
                        ...
                        {etapaAtual === 3 && (
                            <div className="payment-card success-card">
                                ...
                                <p className="success-message">
                                    Sua assinatura do plano <strong>{planoSelecionado.nome}</strong> foi confirmada com sucesso!
                                </p>
                                ...
                                {metodoPagamento === 'pix' && (
                                    <div className="pix-confirmed">
                                        <p>Pagamento identificado! Sua assinatura já está ativa.</p>
                                    </div>
                                )}
                                ...
                                <div className="success-actions">
                                    ...
                                    <button className="btn-back-home" onClick={voltarParaPlanos}>
                                        Ver Outros Planos
                                    </button>
                                </div>
                            </div>
                    ...
                    <div className="payment-resume">
                        <div className="resume-card">
                            ...
                            <div className="resume-plan">
                                <div className="plan-badge">{planoSelecionado.badge}</div>
                                <h4>{planoSelecionado.nome}</h4>
                                <p className="plan-description">{planoSelecionado.descricao}</p>
                            </div>
                            ...
                            <div className="resume-items">
                                <div className="resume-item">
                                    ...
                                    <strong>{planoSelecionado.preco}</strong>
                                </div>
                                <div className="resume-item">
                            ...
                            <div className="resume-total">
                                <span>Total</span>
                                <strong className="total-value">{planoSelecionado.preco}</strong>
                            </div>
