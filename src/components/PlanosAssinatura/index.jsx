        ...
        const boosts = {
            '7dias': {
                ...
                beneficios: [
                    ...
                    'Maior visibilidade por 7 dias',
                    'Aparições na busca prioritária'
                ]
            },
            '15dias': {
                duracao: '15 dias',
                ...
                beneficios: [
                    'Destaque no topo dos resultados',
                    'Selo de "Anúncio em Destaque"',
                    'Maior visibilidade por 15 dias',
                    'Aparições na busca prioritária',
                    'Economia de 20%'
                ]
            },
            '30dias': {
                ...
                beneficios: [
                    'Destaque no topo dos resultados',
                    'Selo de "Anúncio em Destaque"',
                    'Maior visibilidade por 30 dias',
                    'Aparições na busca prioritária',
                    'Destaque na página inicial',
                    'Economia de 35%'
                ]
