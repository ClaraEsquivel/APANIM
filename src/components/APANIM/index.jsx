                ...
                <section className="cta-section">
                    <div className="cta-content">
                        ...
                        <div className="cta-buttons">
                            <a href="../AdocaoAnimal/index.jsx" className="btn-cta btn-primary">
                                🐾 Adotar um Pet
                            </a>
                            <a href="../Parceria/index.jsx" className="btn-cta btn-secondary">
                                🤝 Ser Parceiro
                            </a>
                        </div>
                        ...
                        <div className="email-info">
                            ...
                            <p className="email-address">contato@apanim.com.br</p>
                        </div>
                    </div>
                </section>
