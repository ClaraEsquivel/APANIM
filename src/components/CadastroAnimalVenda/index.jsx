...
const CadastroAnimalVenda = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // exemplo: await fetch('/api/animais-venda', { method: 'POST', body: JSON.stringify(animalData) })
            ...
            <div className="central_cadastro_animal">
                ...
                <div className="container_cadastro_animal">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        {/* Valor */}
                        <div className="form-group_cadastro_animal">
                            <label htmlFor="valor-animal" className="form-label_cadastro_animal">Valor </label>
                            <input 
                                type="text" 
                                className="form-control_cadastro_animal" 
                                id="valor-animal" 
                                ...
                                required
                            />
                            <small className="form-text_cadastro_animal">Digite apenas números, a formatação é automática</small>
                        </div>
                        ...
                        <div className="form-group_cadastro_animal">
                            ...
                            <small className="form-text_cadastro_animal">Informe o bairro onde o animal se encontra</small>
                        </div>
